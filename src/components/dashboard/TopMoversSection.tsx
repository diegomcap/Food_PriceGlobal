...
function MoversColumn({
  ...
  return (
    <div className="rounded-[2rem] border border-white/10 bg-white/[0.05] p-6 shadow-[0_20px_80px_rgba(15,23,42,0.18)] backdrop-blur-xl">
      ...
      <div className="space-y-4">
        {items.map((item, index) => (
          <article
            key={item.symbol}
            className="rounded-[1.5rem] border border-white/10 bg-slate-950/45 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-white/20 hover:bg-slate-950/55"
          >
            <div className="mb-3 flex items-start justify-between gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-white">{t(item.id)}</h4>
              ...
              <div className={`text-sm font-bold ${tone === 'emerald' ? 'text-emerald-300' : 'text-rose-300'}`}>
            ...
            <div className="flex items-center justify-between gap-4 text-sm">
              ...
              <div className="rounded-full border border-white/10 bg-white/[0.04] px-3 py-1 text-slate-300">
                {item.unit}
              </div>
            </div>
...
export default function TopMoversSection() {
  ...
  return (
    <section id="top-movers" className="relative overflow-hidden bg-slate-950 py-20 text-white">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="max-w-3xl text-slate-300">{copy.subtitle}</p>
            <div className="mt-4 inline-flex items-center gap-2 rounded-full border border-emerald-400/20 bg-emerald-400/10 px-4 py-2 text-xs font-semibold text-emerald-100">
