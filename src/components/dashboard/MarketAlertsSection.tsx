...
export default function MarketAlertsSection() {
  ...
  return (
    <section id="alertas-mercado" className="py-16 bg-slate-950 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {loading && alerts.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5">
            {alerts.map((alert) => (
              <article key={alert.id} className="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm">
                ...
                <h3 className="text-lg font-semibold text-white mb-3 leading-tight">{alert.title}</h3>
                <p className="text-sm leading-6 text-slate-300">{alert.detail}</p>
