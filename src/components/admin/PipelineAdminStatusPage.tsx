...
const COPY = {
  pt: {
    back: '← Voltar',
    title: 'Status Admin da Pipeline',
    subtitle: 'Observabilidade operacional completa de ingestao, serving, fallback e ingestion runs dos datasets de mercado.',
  ...
  en: {
    back: '← Back',
    title: 'Admin Pipeline Status',
    subtitle: 'Complete operational observability for ingestion, serving, fallback and ingestion runs across market datasets.',
  ...
  es: {
    back: '← Volver',
    title: 'Estado Admin de la Pipeline',
    subtitle: 'Observabilidad operativa completa de la ingesta, serving, fallback e ingestion runs de los datasets de mercado.',
...
export default function PipelineStatusPage() {
  ...
  async function loadStatus() {
    try {
      setError(null);
      const response = await fetch('/api/internal/pipeline/status');
      if (!response.ok) {
